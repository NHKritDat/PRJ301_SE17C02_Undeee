        ...
        <div class="row">
            <div style="text-align: center" class="form-group col-md-4">
                ...
                <div style="text-align: center;">
                    <img class="imgFile" src="views/products/<%= product.getImage()%>" alt="Product image" id="previewImage">
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div style="margin: 0 !important;" class="form-group">
                    <select value="<%= product.getCategory_id()%>" class="form-control"  id="loaiSanPham" name="category">
                        ...
                        %>
                        <option value="<%= category.getCategory_id()%>" <%if (product.getCategory_id() == category.getCategory_id()) {%>selected=""<%}%>><%= category.getName()%></option>
                        <%
                            }
                        %>     
                    </select>
                ...
                <div class="form-group">
                    <select value="<%= product.getStatus()%>" style="appearance:auto; "  name="status" class="form-control" id="status">
                ...
                <div style="text-align: center" >
                    <button  type="submit" class="buttonA">Update product</button>
